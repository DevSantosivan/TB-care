...
$query = mysqli_query($con, "SELECT * FROM november WHERE log_id = '$log_id'");
...
if (isset($_POST['d1'])) {
    ...
    $update_query = mysqli_query($con, "UPDATE november SET i1=1 WHERE log_id = '$log_id'");
    if ($update_query) {
    ...
    $update_query = mysqli_query($con, "UPDATE november SET i1=2 WHERE log_id = '$log_id'");
    if ($update_query) {
    ...
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i2=1 WHERE log_id = '$log_id'");
    ...
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i2=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i3=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i3=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i4=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i4=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i5=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i5=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i6=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i6=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i7=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i7=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i8=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i8=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i9=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i9=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i10=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i10=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i11=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert"> Successfully updated.
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">×</span>
    ...
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i11=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i12=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i12=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i13=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i13=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i14=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i14=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i15=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i15=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i16=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i16=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i17=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i17=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i18=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i18=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i19=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i19=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i20=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i20=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i21=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert"> Successfully updated.
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">×</span>
    ...
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i21=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i22=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i22=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i23=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i23=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i24=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i24=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i25=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i25=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i26=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i26=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i27=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i27=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i28=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i28=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i29=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i29=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i30=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i30=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i31=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE november SET i31=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
            ...
            <div class="row">
                ...
                <div class="content-wrapper" style="background-color:skyblue;">
                    ...
                    <div class="card card-statistics h-100">
                        <br>
                        <center><h1> <b>NOVEMBER</h1></center>
                        <div class="content ">
                            <?php echo $status; ?>
