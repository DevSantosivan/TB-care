        ...
        if (move_uploaded_file($_FILES['picture']['tmp_name'], $pictureUploadFile)) {
            ...
            if (isset($_FILES['document']) && $_FILES['document']['error'] === UPLOAD_ERR_OK) {
                ...
                if (move_uploaded_file($_FILES['document']['tmp_name'], $documentUploadFile)) {
                    ...
                    $insertPatientQuery = "INSERT INTO february (i1) VALUES ('0')";
                    mysqli_query($con, $insertPatientQuery);
                    $insertPatientQuery = "INSERT INTO february (i1) VALUES ('0')";
                    mysqli_query($con, $insertPatientQuery);
                    $insertPatientQuery = "INSERT INTO march (i1) VALUES ('0')";
                    mysqli_query($con, $insertPatientQuery);
                    $insertPatientQuery = "INSERT INTO april (i1) VALUES ('0')";
                    mysqli_query($con, $insertPatientQuery);
                    $insertPatientQuery = "INSERT INTO may (i1) VALUES ('0')";
                    mysqli_query($con, $insertPatientQuery);
                    $insertPatientQuery = "INSERT INTO june (i1) VALUES ('0')";
                    mysqli_query($con, $insertPatientQuery);
                    $insertPatientQuery = "INSERT INTO july (i1) VALUES ('0')";
                    mysqli_query($con, $insertPatientQuery);
                    $insertPatientQuery = "INSERT INTO august (i1) VALUES ('0')";
                    mysqli_query($con, $insertPatientQuery);
                    $insertPatientQuery = "INSERT INTO september (i1) VALUES ('0')";
                    mysqli_query($con, $insertPatientQuery);
                    $insertPatientQuery = "INSERT INTO october (i1) VALUES ('0')";
                    mysqli_query($con, $insertPatientQuery);
                    $insertPatientQuery = "INSERT INTO november (i1) VALUES ('0')";
                    mysqli_query($con, $insertPatientQuery);
                    $insertPatientQuery = "INSERT INTO december (i1) VALUES ('0')";
                    mysqli_query($con, $insertPatientQuery);
                    $status = '<div class="alert alert-success alert-dismissible" role="alert">
...
if ($user_rank == 'normal') {
    ...
    if ($patientstatus == 1) {
        echo 'NEW PATIENT';
    } elseif ($patientstatus == 2) {
        echo 'RETURNE PATIENT';
    } elseif ($patientstatus == 3) {
        echo 'RELAPSE PATIENT';
    } else {
        echo 'UNKNOWN STATUS';
    }
    ?>
