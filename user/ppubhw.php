...
<body>
 ...
 Main content -->
            ...
            <div class="row">
                ...
                <div class="content-wrapper" style="background-color:skyblue;">
                    <div class="page-title">
                        <div class="row">
                            <div class="col-sm-6">
                                <h4 class="mb-0">PATIENT PROGRESS UPDATE</h4>
                            </div>
                            <div class="col-sm-6">
    ...
    // Fetch the logged-in username (ensure $t['user_name'] contains the correct value)
    ...
    // Query to select patients based on uname and progress conditions
    ...
    ?>
                        <div class="grid-item">
                            ...
                            <div class="user-info">
                                ...
                                <div class="row">
                                    <form method="post" action="profile" class="form-inline">
                                        <input type="hidden" name="log_id" value="<?php echo $row['log_id']; ?>">
                                        <button type="submit" class="btn btn-primary btn-sm">PROGRESS</button>
                                    </form>
                                    <div class="form-space"></div> <!-- Add this div for spacing -->
                                    <form method="post" action="progup" class="form-inline">
                                        <input type="hidden" name="log_id" value="<?php echo $row['log_id']; ?>">
