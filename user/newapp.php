...
<body>
 ...
 Main content -->
            ...
            <div class="row">
                ...
                <div class="content-wrapper" style="background-color:skyblue;">
                    <div class="page-title">
                        <div class="row">
                            <div class="col-sm-6">
                                <h4 class="mb-0">NEW APPOINTMENTS</h4>
                            </div>
                            <div class="col-sm-6">
    ...
    if ($user_rank == 'normal') {
        ...
        // Query to fetch patient records where appointmentdate is today
        ...
        // Query to fetch all patient records where appointmentdate is today
        $query = mysqli_query($con, 
            "SELECT * FROM patient 
