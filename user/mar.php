...
$query = mysqli_query($con, "SELECT * FROM march WHERE log_id = '$log_id'");
...
if (isset($_POST['d1'])) {
    ...
    $update_query = mysqli_query($con, "UPDATE march SET i1=1 WHERE log_id = '$log_id'");
    if ($update_query) {
    ...
    $update_query = mysqli_query($con, "UPDATE march SET i1=2 WHERE log_id = '$log_id'");
    if ($update_query) {
    ...
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i2=1 WHERE log_id = '$log_id'");
    ...
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i2=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i3=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i3=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i4=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i4=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i5=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i5=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i6=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i6=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i7=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i7=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i8=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i8=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i9=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i9=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i10=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i10=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i11=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert"> Successfully updated.
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">×</span>
    ...
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i11=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i12=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i12=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i13=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i13=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i14=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i14=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i15=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i15=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i16=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i16=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i17=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i17=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i18=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i18=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i19=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i19=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i20=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i20=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i21=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert"> Successfully updated.
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">×</span>
    ...
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i21=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i22=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i22=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i23=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i23=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i24=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i24=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i25=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i25=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i26=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i26=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i27=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i27=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i28=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i28=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i29=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i29=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i30=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i30=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i31=1 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    $log_id = mysqli_real_escape_string($con, $_POST['log_id']);
    $updatemonitoringQuery = mysqli_query($con, "UPDATE march SET i31=2 WHERE log_id = '$log_id'");
    if ($updatemonitoringQuery) {
        $status = '<div class="alert alert-success alert-dismissible" role="alert">
                    Successfully updated.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
